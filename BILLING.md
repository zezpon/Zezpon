...
3. If a checkout URL exists for the selected plan, signup redirects them to hosted checkout
...
- Confirm Basic and Premium checkout open from signup and membership
